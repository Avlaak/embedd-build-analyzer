...
const GITHUB_OWNER = 'Avlaak';
const GITHUB_REPO = 'embedd-build-analyzer';
const VSIX_PREFIX = 'embedd-build-analyzer-';
const EXTENSION_ID = 'embedd-team.embedd-build-analyzer';
const EXTENSION_DISPLAY_NAME = 'Embedd Build Analyzer';
const CONFIG_SECTION = 'EmbeddBuildAnalyzer';
